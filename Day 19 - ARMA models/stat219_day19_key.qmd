...
$$
\begin{split}
x_t = w_t + .5 \boldsymbol{B} w_t -.4 \boldsymbol{B}^2 w_t = (1 + .5 \boldsymbol{B} -.4 \boldsymbol{B}^2) w_t
\end{split}
$$
...
\begin{split}
x_t &= x_{t-1} - \frac{1}{4}x_{t-2} + w_t + \frac{1}{2}w_{t-1} \\
(1 - \boldsymbol{B} + \frac{1}{4} \boldsymbol{B}^2)x_t &= (1 + \frac{1}{2}\boldsymbol{B})w_t \\
(1 - \boldsymbol{B} + \frac{1}{4} \boldsymbol{B}^2)x_t &= (1 + \frac{1}{2}\boldsymbol{B})w_t  \\
(1 - \frac{1}{2}\boldsymbol{B})^2 x_t &= (1 + \frac{1}{2} \boldsymbol{B})w_t
\end{split}
$$
$\theta_p(\boldsymbol{B})$ has one root at 2 and is therefore stationary. $\phi_q(\boldsymbol{B})$ has one root at -2 and is therefore invertible.
