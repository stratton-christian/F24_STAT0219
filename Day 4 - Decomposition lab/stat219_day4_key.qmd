...
\newpage
   ...
   c) [2 pt] Calculate the trend component for 1900-07 to 1851-07 **by hand**. Verify you have correctly calculated the trend component by printing out a table of the trend component calculated by hand and via the decompose function. 
...
res <- vt_ts - vt_trend_full - rep(seasonal_means_centered, 101)
